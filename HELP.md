...
* The original package name 'com.raddatzk.spring-native-graal' is invalid and this project uses 'com.raddatzk.springnativegraal' instead.
...
```
$ docker run --rm -p 8080:8080 spring-native-graal:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/spring-native-graal
```
